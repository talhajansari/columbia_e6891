function [y,e,x] = powspec(x, sr, wintime, steptime, dither)
...
%y = abs(spectrogram(x*32768,WINDOW,NOVERLAP,NFFT,Fs)).^2;
x = specgram(x*32768,NFFT,SAMPRATE,WINDOW,NOVERLAP);
y = abs(x).^2;
